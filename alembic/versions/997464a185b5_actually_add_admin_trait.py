"""actually add admin trait

Revision ID: 997464a185b5
Revises: e786632fb372
Create Date: 2020-04-19 05:17:13.534915
...
revision = '997464a185b5'
down_revision = 'e786632fb372'
branch_labels = None
depends_on = None


def upgrade():
    op.add_column('user', Column('admin', Boolean(), server_default=sa.false()))
    pass


def downgrade():
    drop_column_sqlite('user', ['admin'])
